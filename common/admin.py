...
# Register the SiteConfiguration model with the custom admin class
...
class SiteConfigurationAdmin(SingletonModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        """
        Override the save_model method to set created_by and updated_by fields when saving the model.
        Args:
            request (HttpRequest): The incoming request.
            obj: The object being saved.
            form: The form used to save the object.
